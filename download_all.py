...
def download_all(phpsessid):
    ...
    for subject_id, id in subjects:
        files += [
            ...
            ('Angles_D3_{}.tgz'.format(subject_id),
            'download=1&filepath=Poses/D3_Angles&filename=SubjectSpecific_{}.tgz'.format(id)),
            ('Angles_D3_mono_{}.tgz'.format(subject_id),
            'download=1&filepath=Poses/D3_Angles_mono&filename=SubjectSpecific_{}.tgz'.format(id)),
            ('RawAngles_{}.tgz'.format(subject_id),
            'download=1&filepath=Poses/RawAngles&filename=SubjectSpecific_{}.tgz'.format(id)),
